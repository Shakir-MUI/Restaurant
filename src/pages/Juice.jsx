...
const fallbackJuiceItems = [
  ...
  },
  {
    ...
    image: "https://image.freepik.com/free-photo/refreshing-mojito-with-lime-mint-ice-glas_275899-968.jpg",
  },
  {
    id: "ju7",
...
export default function Juice() {
  ...
  // ✅ Handle Likes (Store in Firebase)
  const handleLike = async (itemId) => {
    ...
    try {
      const current = updatedItems.find((i) => i.id === itemId);
      await axios.patch(`${BASE_URL}/menu/juice/${itemId}.json`, {
        likes: current.likes,
      });
    } catch (err) {
              ...
              >
                ...
                <div className="card-body bg-dark text-white d-flex flex-column">
                  ...
                  <div className="mt-2 d-flex align-items-center justify-content-between">
                    ...
                    <span>{item.likes || 0} {item.likes === 1 ? "Like" : "Likes"}</span>
                  </div>
                </div>
              </div>
            </div>
